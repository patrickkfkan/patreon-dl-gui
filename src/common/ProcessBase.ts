...
import type {
  ServerConsoleMainEvent,
  ServerConsoleMainEventListener,
  ServerConsoleRendererEvent,
  ServerConsoleRendererEventListener
} from "../server-console/types/ServerConsoleEvents";
import type {
  ServerConsoleInvocableMethod,
  ServerConsoleInvocableMethodHandler
} from "../server-console/types/ServerConsoleInvocableMethods";
...
> =
  ...
  : M extends ServerConsoleInvocableMethod ?
    ServerConsoleInvocableMethodHandler<M>
  : never;
